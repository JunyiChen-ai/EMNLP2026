"""Train/evaluate with AppraiseHate v10 features without touching main.py."""
...
def main():
    parser = argparse.ArgumentParser(description="AppraiseHate v10: Train and Evaluate")
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="HateMM",
    ...
    logger.info(f"Loading v10 features from {emb_dir}...")
    features = {
        ...
        "t1": torch.load(f"{emb_dir}/v10_t1_features.pth", map_location="cpu"),
        "t2": torch.load(f"{emb_dir}/v10_t2_features.pth", map_location="cpu"),
