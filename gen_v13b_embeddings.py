"""
Generate v13b embeddings from AppraiseHate v13b LLM outputs (Harmful/Normal).

Same structure as v13: Group A (perception/cognition/answer) + Group B (per-field).
Label in v13b is Harmful/Normal instead of Hateful/Non-hateful.
"""
...
def main():
    ...
    perception_texts, cognition_texts, answer_texts = {}, {}, {}
    ...
    # Save with v13b prefix
    torch.save(perception_feats, os.path.join(out_dir, "v13b_perception_features.pth"))
    torch.save(cognition_feats, os.path.join(out_dir, "v13b_cognition_features.pth"))
    torch.save(answer_feats, os.path.join(out_dir, "v13b_answer_features.pth"))
    for f in field_names:
        torch.save(field_feats[f], os.path.join(out_dir, f"v13b_ans_{f}_features.pth"))

    print(f"\nSaved v13b embeddings to {out_dir}/")
